...
export default function WaitlistLanding() {
  ...
  return (
    <div className="relative h-screen overflow-hidden bg-gradient-to-br from-[#0B1B22] to-[#000000] text-neutral-900 antialiased dark:text-neutral-100 flex flex-col">
      <BackgroundAccents />
      
      <section className="relative w-full px-0 flex-1 flex items-center pb-8" id="hero">
        <div className="w-full rounded-none sm:rounded-3xl border-0 sm:border border-neutral-200/60 dark:border-neutral-800/70 bg-white/70 dark:bg-neutral-900/60 backdrop-blur-sm px-0 py-4 sm:p-10 h-full flex items-center">
...
function HeroContent({ email, submitted, error, onEmailChange, onSubmit }) {
  return (
    <div>
      <div className="flow lg:inline-flex items-center gap-2 rounded-full border border-neutral-200/70 dark:border-neutral-800 bg-white/70 dark:bg-neutral-950/40 px-3 py-1 text-xs text-neutral-600 dark:text-neutral-300 mx-auto lg:mx-0 w-fit">
      ...
      <p className="mt-4 text-neutral-700 dark:text-neutral-300 text-lg max-w-prose mx-4 lg:mx-0">
        Clipzy helps <span className="text-[#9146FF] font-medium">Twitch</span> creators collect, manage, and export clips fast—so you can post more and get back to streaming.
      </p>
...
function PlatformBadges() {
  return (
    <div className="mt-6 flex items-center gap-3 text-xs text-neutral-600 dark:text-neutral-400 justify-center lg:justify-start">
      ...
      <PlatformBadge icon={<MonitorSmartphone className="h-3.5 w-3.5" />} label="macOS" note="20%" />
    </div>
  );
}
...
function WaitlistForm({ email, submitted, error, onEmailChange, onSubmit }) {
  ...
  return (
          <div className="mt-8" id="join">
        <div className="rounded-2xl border border-neutral-200/70 dark:border-neutral-800 bg-[#0E1821] shadow-sm p-3 sm:p-4 mx-auto lg:mx-0 ring-1 ring-blue-500/30 shadow-blue-500/20">
          ...
          <button
            type="submit"
            className="inline-flex items-center justify-center gap-2 rounded-xl px-4 py-3 bg-[#082C50] hover:bg-[#0A3A6B] active:scale-[.99] transition shadow-sm text-[#22BAD8]"
          >
        ...
        <p className="mt-2 text-[11px] text-neutral-500 dark:text-neutral-400 text-center lg:text-left">Join 2000+ creators - 1 free month of Premium if you sign up now</p>
        <div className="mt-3 text-center">
          <a 
            href="https://twitch.tv/fr0zair" 
            target="_blank" 
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 text-xs text-neutral-600 dark:text-neutral-400 hover:text-neutral-800 dark:hover:text-neutral-200 transition-colors"
          >
  ...
  return (
    ...
    >
      <div className="w-full flex justify-center lg:justify-end">
        <div className="relative h-[400px] w-[200px] sm:h-[500px] sm:w-[250px] lg:h-[640px] lg:w-[320px] rounded-[2.2rem] shadow-2xl overflow-hidden">
      ...
      <p className="absolute -bottom-6 text-center text-xs text-neutral-500 w-full">Real app preview</p>
    </div>
  );
}
